...
# Extracting all English texts into one comma-separated string
mockup_english = ", ".join([json.dumps(item["text"]) for item in mockups["mockups_cover_letter"]["english"]])

# Extracting all German texts into one comma-separated string
mockup_german = ", ".join([json.dumps(item["text"]) for item in mockups["mockups_cover_letter"]["german"]])
